...
**Pages**
- Track location: [https://owntracker-1.onrender.com/](https://owntracker-1.onrender.com/)
- All devices map: [https://owntracker-1.onrender.com/viewer](https://owntracker-1.onrender.com/viewer)
- 3D path and STL export: [https://owntracker-1.onrender.com/3d](https://owntracker-1.onrender.com/3d)
- 3D path for one device: `https://owntracker-1.onrender.com/3d?device=<device-id>`

**API**
- Device list: [https://owntracker-1.onrender.com/api/devices](https://owntracker-1.onrender.com/api/devices)
- Server check: [https://owntracker-1.onrender.com/api/health](https://owntracker-1.onrender.com/api/health)
